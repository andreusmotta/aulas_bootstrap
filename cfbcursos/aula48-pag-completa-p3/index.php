      ...
      <div class="row">
        ...
        <aside class="col-sm-4">
          ...
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a href="https://pokemontabletop.com/" class="nav-link">Pokémon Tabletop United 1.05</a>
            </li>
            <li class="nav-item">
              <a href="https://pensamentocoletivo.com.br/role-playing-games/mutant-ano-zero/" class="nav-link">Mutante Ano Zero</a>
            </li>
            <li class="nav-item">
              <a href="https://pelgranepress.com/trail-of-cthulhu/" class="nav-link">Rastro de Cthulhu</a>
            </li>
            <li class="nav-item">
              <a href="https://www.chaosium.com/call-of-cthulhu-rpg/" class="nav-link">Chamado de Cthulhu</a>
            </li>
            <li class="nav-item">
              <a href="https://theonyxpath.com/category/worlds/classicworldofdarkness/magetheascension/" class="nav-link">Mago A Ascenção</a>
            </li>
          </ul>
        </aside>
      </div>
